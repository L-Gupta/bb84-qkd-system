  ...
  return (
    <div className="card">
      ...
      <div className="grid-2">
        ...
        <div className={`security-box ${secure ? 'security-secure' : 'security-insecure'}`}>
          <div className={`security-title ${secure ? 'security-title-secure' : 'security-title-insecure'}`}>
